...
document.getElementById("btn1").addEventListener("click", function() {
    ...
    console.log(test.childNodes[5].previousSibling.nextSibling)
})
...
document.getElementById("btn2").addEventListener("click", function() {
        ...
        test.children[2].previousElementSibling
})

document.getElementById("test").children[2].previousElementSibling.addEventListener("mouseup", function() {
    // this == 이벤트가 발생한 요소
    // == #test의 자식 요소 중 2번째 인덱스의 이전 형재 요소
