...
document.getElementById("check2").addEventListener("click", function() {
    ...
    // ^(캐럿) : 문자열의 시작을 의미
    const regEx2 = /^group/;
    div1.innerHTML += "/^group/ , apple : " + regEx2.test("group100") + "<hr>";
...
//     console.log(regEx5.test(input.value));

//     if(regEx5.test(input.value)) {
//         result.innerText = "유효한 이름"
//     } else {
//         result.innerText = "잘못된 형식"
//     }
