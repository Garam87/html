...
function test() { //test 함수 정의
    ...
    console.log("함수 내부 num 3 ; " + num3);
    console.log("함수 내부 num 4 ; " + num4);
...
function plus() {
    ...
    let sum = num1 + num2;
    console.log(sum);
    result.innerHTML = "<div class='result'><p>계산 결과 :" + sum + "</p></div>";
}
...
function minus() {
    ...
    let minus = num1 - num2;
    console.log(minus);
    result.innerHTML = "<div class='result'><p>계산 결과 :" + minus + "</p></div>";
}
...
function double() {
    ...
    result.innerHTML = "<div class='result'><p>계산 결과 :" + multiply + "</p></div>";
}
...
function divi() {
    ...
    console.log(divide);
    result.innerHTML = "<div class='result'><p>계산 결과 :" + divide + "</p></div>";
}
...
function percent() {
    ...
    console.log(percent);
    result.innerHTML = "<div class='result'><p>계산 결과 :" + percent + "</p></div>";
}